...
@Component({
  ...
  imports: [RouterOutlet, NavbarComponent], // Importación de RouterOutlet para que el componente pueda usar las rutas con la etiqueta <router-outlet></router-outlet>
